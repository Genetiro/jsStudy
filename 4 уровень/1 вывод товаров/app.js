...
let b = document.querySelector('.products')
...
function showCategory(category) {
    ...
    c.forEach(function(product) {
        d += getProductMarkup(product);
    });
    b.insertAdjacentHTML("afterbegin", d);
};
...
function getProductMarkup(product) {
    ...
    <a ref = "https://example.com/producs/${product.id}" > Подробнее </a> </div>`;
};